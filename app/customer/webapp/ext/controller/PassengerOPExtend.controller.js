      ...
      */
      ...
      routing: {
        onAfterBinding: async function (oBindingContext) {
          ...
          const oBookingTableAPI = oExtensionAPI.byId("fe::CustomSubSection::Bookings--OwnBookingsTable")
          const oWarningMessage = new Message({
            type: MessageType.Warning,
            message: await oExtensionAPI.getModel("i18n").getResourceBundle().getText("bookingsNew")
          })
          const oInfoMessage = new Message({
